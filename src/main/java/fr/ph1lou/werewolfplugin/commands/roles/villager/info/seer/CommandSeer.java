    ...
    public void execute(WereWolfAPI game, IPlayerWW playerWW, String[] args) {
        ...
        if (playerWW.getHealth() < 7) {
            ...
            if (seerEvent.getCamp().equals(Camp.VILLAGER.getKey())) {
                ...
                playerWW.sendMessageWithKey(Prefix.RED , "werewolf.role.seer.see_villager");
                if (seer.isKey(RoleBase.CHATTY_SEER)) {
                    Bukkit.broadcastMessage(game.translate(Prefix.YELLOW , "werewolf.role.chatty_seer.see_perform",
                ...
                playerWW.sendMessageWithKey(Prefix.YELLOW , "werewolf.role.seer.see_perform",
