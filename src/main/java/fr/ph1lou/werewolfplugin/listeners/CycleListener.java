...
public class CycleListener implements Listener {
    ...
    public void onDay(DayEvent event) {
        ...
        BukkitUtils.scheduleSyncDelayedTask(game, () -> Bukkit.getPluginManager().callEvent(new NightEvent(event.getNumber())), game.getConfig().getTimerValue(TimerBase.DAY_DURATION) * 20L);
