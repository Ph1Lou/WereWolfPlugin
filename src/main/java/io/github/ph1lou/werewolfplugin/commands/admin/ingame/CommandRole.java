...
public class CommandRole implements Commands {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (!sender.hasPermission("a.role.use") && !game.getModerationManager().getModerators().contains(((Player) sender).getUniqueId()) && !game.getModerationManager().getHosts().contains(((Player) sender).getUniqueId())) {
