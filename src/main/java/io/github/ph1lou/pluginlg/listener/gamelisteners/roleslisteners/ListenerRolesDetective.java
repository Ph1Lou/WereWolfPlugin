...
public class ListenerRolesDetective extends ListenerRoles {
    ...
    public void onDay(Player player, PlayerLG plg) {
        plg.setPower(true);
        player.sendMessage(String.format(game.text.powerUse.get(RoleLG.DETECTIVE), game.score.conversion(game.config.timerValues.get(TimerLG.POWER_DURATION))));
    }
