...
public class ListenerRolesProtector implements ListenerRoles {
    ...
    public void onDay(Player player, PlayerLG plg) {
        plg.setPower(true);
        player.sendMessage(String.format(main.text.powerUse.get(RoleLG.SALVATEUR), main.score.conversion(main.config.timerValues.get(TimerLG.POWER_DURATION))));
    }
