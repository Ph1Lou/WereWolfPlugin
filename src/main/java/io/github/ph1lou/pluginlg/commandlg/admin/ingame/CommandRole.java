...
public class CommandRole extends Commands {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (!sender.hasPermission("adminLG.use") && !sender.hasPermission("adminLG.role.use") && !game.getModerators().contains(((Player) sender).getUniqueId()) && !game.getHosts().contains(((Player) sender).getUniqueId())) {
