...
public enum RoleLG {
	...
	MINEUR("§6§lMineur§r",Camp.VILLAGE,true,"Vous êtes un simple Villageois (avec une pioche :))","",""),
	CITOYEN("§7§lCitoyen§r",Camp.VILLAGE,true," Vous pourrez une fois dans la partie, visualiser les votes de tous les joueurs ou annuler le vôte ","Vous pouvez annuler le vote §6/lg cancelvote§r ou dépouiller le vote §6/lg depouiller§r vous avez ","Vote annulé, vous avez sauvé "),
	FRERE_SIAMOIS("§1§lFrère Siamois§r",Camp.VILLAGE,true,"Séparé à la naissance de votre/vos frère(s) vous avez gardé un lien puissant. Vos barres de vies sont ainsi reliées à 66%","",""),
	ANGE("§5§lAnge§r",Camp.NEUTRE,true,"Vous êtes Ange, votre objectif est de gagner seul, si vous choisissez Ange Gardien, vous devrez protéger une personne choisie aléatoirement et gagner avec elle (ou seul). Si celle-ci meurt, vous repasserez à 10 coeurs. Si vous choisissez Ange Déchu, une cible vous est assignée aléatoirement si vous la tuez, vous passerez à 15 coeurs jusqu'à la fin de la partie.","Vous pouvez décider d'être sois Ange Déchu §6/lg dechu§r sois Ange Gardien §6/lg gardien§r vous avez ","Vous venez de choisir "),
	ANGE_GARDIEN("§5§lAnge Gardien§r",Camp.NEUTRE,true,"Vous devez protéger une personne choisie aléatoirement et gagner §4seul§r avec elle (ou seul). Si celui-ci meurt, vous repassez à 10 coeurs.","","Votre protégé est "),
	ANGE_DECHU("§5§lAnge Déchu§r",Camp.NEUTRE,true,"Vous devez gagner seul. Vous possédez 12 coeurs de vie. Une cible vous est assignée aléatoirement si vous la tuez, vous passerez à 15 coeurs jusqu'à la fin de la partie.","","Votre cible est "),
	...
	LOUP_GAROU_BLANC("§c§lLoup Garou Blanc§r",Camp.NEUTRE,true,"Votre objectif est de gagner seul, vous êtes infiltré parmis les Loups Garous. Vous avez Force la nuit et 2min de speed et d'abso après chaque kill, ainsi que 15 coeurs permanents","",""),
	ASSASSIN("§6§lAssassin§r",Camp.NEUTRE,true,"Votre objectif est de gagner seul, vous êtes infiltré parmis les Villageois. Vous avez Force le jour.","",""),
	TUEUR_EN_SERIE("§9§lTueur en série§r",Camp.NEUTRE,true,"Votre objectif est de gagner seul, vous êtes infiltré parmis les Villageois. Vous gagnez un slot de coeur supplémentaire par personne tuée","","");
