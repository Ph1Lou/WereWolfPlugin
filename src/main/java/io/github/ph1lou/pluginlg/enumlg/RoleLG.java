...
public enum RoleLG {
	...
	LOUP_FEUTRE("v4§lLoup Feutr§r",Camp.LG,true,"Vous avez un rôle d'affichage différent chaque jour parmi ceux encore en vie pour tromper les Villageois","Votre Rôle d'affichage aujourd'hui est ",""),
