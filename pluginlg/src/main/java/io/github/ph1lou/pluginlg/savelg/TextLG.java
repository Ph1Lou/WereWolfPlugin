...
public class TextLG {
	...
	public final String[][] DEFAULT= {
			...
			/*30*/	" par amour, le rejoins dans sa tombe",
					...
					" a été tué par ",
					esthetique("§m", "§2","Vous avez tué votre cible, vous gagnez 3 coeurs"),
					esthetique("§6§m", "§4","Votre cible a été tué, vous perdez 2 coeurs"),
					...
					"Progression ",
			/*40*/	" §2n'est pas dans le camp des Loups Garous",
					" §4est dans le camp des Loups Garous",
					"Vous êtes ",
			...
			/*70*/	"Vous êtes dans le camp des §eVillageois§r. Votre but est d'éliminer les §4Loups Garous§r et autres dangers du §eVillage§r",
					" §2sont dans le même camp",
					" §4ne sont pas dans le même camp",
					"",
					"",
					"",
